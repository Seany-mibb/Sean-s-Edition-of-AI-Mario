...
{
  Game_Status = 'start';
  document.getElementById('status').innerHTML = 'Importing Game Files'
  ...
  setTimeout(()=>{
    document.getElementById('status').innerHTML = 'Finishing Up Downloads'
  }, 3000)
  setTimeout(()=>{
    document.getElementById('status').innerHTML = 'Finishing Up Downloads ...'
  }, 4000)
  setTimeout(()=>{
    document.getElementById('status').innerHTML = 'Ready to Play!!!'
...
function game(){
  console.log('nose x coordinate is '+ noseX + 'nose y coordinate is '+ noseY);
